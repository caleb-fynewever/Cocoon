...
public class Constants {
    ...
    public static class DrivetrainConstants {
        ...
        */
        public static final SwerveDrivetrainConstants TUNER_DRIVETRAIN_CONSTANTS = TunerConstants.DriveTrain.getDrivetrainConstants();//FakeTunerConstants.DriveTrain.getDrivetrainConstants();
        public static final SwerveModuleConstants[] TUNER_MODULE_CONSTANTS = TunerConstants.DriveTrain.getModuleConstants();//FakeTunerConstants.DriveTrain.getModuleConstants();
