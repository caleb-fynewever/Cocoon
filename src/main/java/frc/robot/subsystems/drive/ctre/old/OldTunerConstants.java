package frc.robot.subsystems.drive.ctre.old;
...
public class OldTunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.35).withKI(0).withKD(0.0).withKS(0).withKV(0).withKA(0);
  ...
  static {
    driveInitialConfigs.CurrentLimits.SupplyCurrentLimit = 30; // go 80 later with real fuses
    driveInitialConfigs.CurrentLimits.SupplyCurrentLimitEnable = false;
  ...
  static {
    steerInitialConfigs.CurrentLimits.StatorCurrentLimit = 20.0; // 50.0;
  ...
  private static final String kCANbusName = "Krawlivore";
